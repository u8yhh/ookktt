...
if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="99af137f-3a11-4df6-9216-c8a37100b991"
fi
echo ${Vless_UUID}
...
if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="99af137f-3a11-4df6-9216-c8a37100b991"
fi
echo ${Vmess_UUID}
...
sed -e "/^#/d"\
    ...
    -e "s/\${Trojan_UUID}/${Trojan_UUID}/g"\
    -e "s|\${Trojan_Path}|${Trojan_Path}|g"\
    -e "s/\${ParameterSSENCYPT}/${ParameterSSENCYPT}/g"\
    -e "s/\${SS_UUID}/${SS_UUID}/g"\
